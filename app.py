...
# 🔹 Sample Scorecard Submission Health Data
...
# Section 1: 📥 Submission Health
st.markdown("### 📥 Scorecard Submission Health")
...
# 🔹 Sample Average Interview Scores Data
...
# Section 2: 📊 Average Interview Scores (Per Candidate)
st.markdown("### 📊 Average Interview Scores (Per Candidate)")
score_chart = alt.Chart(average_scores).mark_bar(color="#1f77b4").encode(
    ...
    y=alt.Y("Candidate:N", sort="-x", title="Candidate"),
